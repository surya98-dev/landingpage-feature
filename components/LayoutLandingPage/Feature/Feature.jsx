...
const Feature = ({ ...otherProps }) => {
  return (
    ...
    <div className="pb-32 my-38 pt-56">

      <div className='lg:w-5/12 mx-auto px-2 '>
        <h2 className='text-center text-4xl font-semibold tracking-widest transform hover:scale-110'>FEATURE</h2>
      </div>
            ...
            <div className="p-6 mb-1 flex flex-col items-center">
              <ul>
                <li className="list-none">
                  <span className="mt-5 mb-2 ml-20 font-bold text-lg tracking-wide">Asset Registration</span>
                </li>
        ...
        <div className="flex flex-col rounded-lg shadow-xl  lg:mb-16 bg-white">
          <div className="p-6 flex flex-col items-center">
            ...
            <div className="p-6 flex flex-col items-center">
              <ul>
                <li className="list-none">
                  <span className="mt-5 mb-2 ml-14 font-bold text-lg tracking-wide text-center">Insightful Dashboard</span>
                </li>
